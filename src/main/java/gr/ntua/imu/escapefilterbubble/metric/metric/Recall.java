...
public class Recall<R> implements Metric {
    ...
    public Recall(Queue<R> recQueue, Queue<R> actualQueue) {
    ...
    public Double calculate() {
        ...
        return new Double(truePositive) / new Double(truePositive + falseNegative);
    }
